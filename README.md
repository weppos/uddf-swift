...
This library implements the UDDF v3.2.3 specification (cumulative over UDDF 3.2.2 and 3.2.3), supporting all major sections:
...
See the [UDDF 3.2.3 specification](https://www.streit.cc/resources/UDDF/v3.2.3/en/index.html) for the authoritative reference.
